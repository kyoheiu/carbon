<script lang="ts">
	import { DEFAULT_LIST_NUMBER } from '$lib/types';
...
{#if !showAll}
	<button
		class="mt-4 mb-4 rounded border border-further bg-itembackground px-2 py-1 text-xs font-semibold text-basecolor"
